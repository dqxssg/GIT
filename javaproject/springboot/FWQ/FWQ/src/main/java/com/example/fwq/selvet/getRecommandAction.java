...
/**
 * Servlet implementation class getRecommandAction
 */
@WebServlet("/getRecommandAction")
public class getRecommandAction extends HttpServlet {
	private static final long serialVersionUID = 1L;

	/**
	 * @see HttpServlet#HttpServlet()
	 */
	public getRecommandAction() {
		super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		db.getRs("select * from actions where recommand=1");
