...
/**
 * Servlet implementation class getDutyByDepartmentId
 */
@WebServlet("/getDutyByDepartmentId")
public class getDutyByDepartmentId extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		db.getRs("select * from onduty where  hospitalId="+hospitalId+" and departmentId=" + departmentId);
