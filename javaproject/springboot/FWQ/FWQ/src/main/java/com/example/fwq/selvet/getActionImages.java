 ...
 */
@WebServlet("/getActionImages")
public class getActionImages extends HttpServlet {
	private static final long serialVersionUID = 1L;

	/**
	 * @see HttpServlet#HttpServlet()
	 */
	public getActionImages() {
		super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		db.getRs("SELECT   *  FROM  actions  where showimage=1 limit 5");
