...
/**
 * Servlet implementation class busMapById
 */
@WebServlet("/busMapById")
public class busMapById extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        db.getRs("select * from bus_map where busid=" + busid);
        ...
        try {
            if (set != null) {
                ...
                while (set.next()) {
                    ...
                    jsonObject3.put("busMap", set.getString(2));
