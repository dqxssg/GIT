...
/**
 * Servlet implementation class getAllHospital
 */
		...
		try {
			if (set != null) {
				...
				while (set.next()) {
					...
					jsonObject3.put("image1", urlString + "/images/" + set.getString(2));
					jsonObject3.put("image2", urlString + "/images/" + set.getString(3));
					jsonObject3.put("image3", urlString + "/images/" + set.getString(4));
					jsonObject3.put("image4", urlString + "/images/" + set.getString(5));
					jsonObject3.put("name", set.getString(6));
					jsonObject3.put("rank", set.getInt(7));
