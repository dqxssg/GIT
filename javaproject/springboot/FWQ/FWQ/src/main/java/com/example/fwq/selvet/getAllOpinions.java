...
/**
 * Servlet implementation class getAllOpinions
 */
@WebServlet("/getAllOpinions")
public class getAllOpinions extends HttpServlet {
	private static final long serialVersionUID = 1L;

	/**
	 * @see HttpServlet#HttpServlet()
	 */
	public getAllOpinions() {
		super();
		...
		try {
			if (set != null) {
				...
				while (set.next()) {
					...
					jsonObject3.put("content", set.getString(2));
