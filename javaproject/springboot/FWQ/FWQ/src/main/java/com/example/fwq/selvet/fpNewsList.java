...
/**
 * Servlet implementation class fpNewsList
 */
@WebServlet("/fpNewsList")
		...
		try {
			if (set != null) {
				...
				while (set.next()) {
					...
					jsonObject3.put("newsid", set.getInt(1));
					jsonObject3.put("newstitle", set.getString(2));
					jsonObject3.put("newsreporter", set.getString(3));
					jsonObject3.put("reporttime", set.getString(4).replace(".0",""));
					jsonObject3.put("newspicture", urlString + "/images/" + set.getString(5));
					jsonObject3.put("newscontent", set.getString(6));
					jsonObject3.put("readnum", set.getInt(7));
					jsonObject3.put("isfront", set.getString(8));
