...
/**
 * Servlet implementation class setAccountGroup
 */
@WebServlet("/setAccountGroup")
public class setAccountGroup extends HttpServlet {
	private static final long serialVersionUID = 1L;

	/**
	 * @see HttpServlet#HttpServlet()
	 */
	public setAccountGroup() {
		super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		try {
		    ...
		    int row=db.update("insert into accountgroup(userid,groupName) values('"+userid+"','"+groupName+"')");
			if (row == 1) {
