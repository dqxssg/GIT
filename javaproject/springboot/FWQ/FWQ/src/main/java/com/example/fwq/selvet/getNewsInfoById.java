...
/**
 * Servlet implementation class getNewsInfoById
 */
@WebServlet("/getNewsInfoById")
public class getNewsInfoById extends HttpServlet {
	private static final long serialVersionUID = 1L;

	/**
	 * @see HttpServlet#HttpServlet()
	 */
	public getNewsInfoById() {
		super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		db.getRs("select * from newsinfo where newsid=" + newsid);
