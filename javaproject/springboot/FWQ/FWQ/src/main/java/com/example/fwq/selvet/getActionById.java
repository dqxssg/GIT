...
/**
 * Servlet implementation class getActionById
 */
@WebServlet("/getActionById")
public class getActionById extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		db.getRs("select * from actions where id=" + id);
