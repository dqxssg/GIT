...
/**
 * Servlet implementation class getNEWSContent
 */
@WebServlet("/getNEWSContent")
public class getNEWSContent extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		db.getRs("select * from newslist where newsid="+newsid);
