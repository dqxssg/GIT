...
public class Adapter_D_XWXQ_LV1 extends ArrayAdapter<S_A_LV> {
    public Adapter_D_XWXQ_LV1(@NonNull Context context, ArrayList<S_A_LV> s_a_lvArrayList) {
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        viewHolder.plzs.setText("观看数：" + s_a_lv.getCommentNum());
        return convertView;
    }
