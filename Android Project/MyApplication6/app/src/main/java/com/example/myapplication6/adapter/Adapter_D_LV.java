...
public class Adapter_D_LV extends ArrayAdapter<S_A_LV> {
    public Adapter_D_LV(@NonNull Context context, ArrayList<S_A_LV> s_a_lvArrayList) {
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        viewHolder.plzs.setText("观看人数：" + s_a_lv.getCommentNum());
        viewHolder.sj.setText("点赞数：" + s_a_lv.getLikeNum());
        return convertView;
    }
