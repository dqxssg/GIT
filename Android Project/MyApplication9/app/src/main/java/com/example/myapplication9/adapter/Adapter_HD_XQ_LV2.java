...
public class Adapter_HD_XQ_LV2 extends ArrayAdapter<S_HD_XQ_LV2> {
    public Adapter_HD_XQ_LV2(@NonNull Context context, ArrayList<S_HD_XQ_LV2> resource) {
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        S_HD_XQ_LV2 s_hd_lv = getItem(position);
