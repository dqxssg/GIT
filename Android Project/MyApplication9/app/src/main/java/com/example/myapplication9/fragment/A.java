...
import com.example.myapplication9.adapter.Adapter_A_GV;
import com.example.myapplication9.adapter.Adapter_A_LV;
import com.example.myapplication9.bean.S_A_GV;
import com.example.myapplication9.bean.S_A_LV;
import com.example.myapplication9.bean.S_A_LV_QT;
import com.example.myapplication9.ui.A_FW;
import com.example.myapplication9.ui.A_SS;
import com.example.myapplication9.ui.A_XQ;
import com.example.myapplication9.ui.HD;
import com.example.myapplication9.ui.MZYY;
import com.example.myapplication9.ui.MainActivity;
import com.example.myapplication9.ui.WZCX;
...
public class A extends Fragment {
                                ...
                                getActivity().runOnUiThread(() -> {
                                    ...
                                    gridview.setOnItemClickListener((parent, view, position, id) -> {
                                        switch (s_a_gvArrayList.get(position).getServiceName()) {
                                            case "活动":
                                                startActivity(new Intent(getActivity(), HD.class));
                                                break;
                                            case "门诊预约":
                                                startActivity(new Intent(getActivity(), MZYY.class));
                                                break;
                                            case "违章查询":
                                                startActivity(new Intent(getActivity(), WZCX.class));
                                                break;
                                            default:
    ...
    private void initView() {
        ...
        banner = (Banner) getView().findViewById(R.id.baanner);
