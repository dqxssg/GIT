...
import com.example.myapplication8.ui.DDLB;
import com.example.myapplication8.ui.GRXX;
import com.example.myapplication8.ui.XGMM;
import com.example.myapplication8.ui.YJFK;
...
public class E extends Fragment {
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        try {
            ...
            new HttpUtil()
                    .sendResuilt("getUserInfo", jsonObject.toString(), "POST", new Callback() {
                        @Override
