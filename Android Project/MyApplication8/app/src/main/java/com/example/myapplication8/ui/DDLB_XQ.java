...
import com.example.myapplication8.adapter.Adapter_DDLB_XQ_LV;
import com.example.myapplication8.bean.S_DDLB_XQ_LV;
...
public class DDLB_XQ extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        try {
            ...
            new HttpUtil()
                    .sendResuilt("getOrderById", jsonObject.toString(), "POST", new Callback() {
                        @Override
