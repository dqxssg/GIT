...
import com.example.myapplication8.adapter.Adapter_DDLB_LV;
import com.example.myapplication8.bean.S_DDLB_LV;
            ...
            spinner.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
                ...
                public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                    ...
                    try {
                        ...
                        new HttpUtil()
                                .sendResuilt("getOrderByType", jsonObject.toString(), "POST", new Callback() {
                                    @Override
