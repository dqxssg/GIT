...
import com.example.myapplication3.bean.ShuJv_TS;
                        ...
                        try {
                            ...
                            runOnUiThread(() -> {
                                try {
                                    ...
                                    new HttpUtil()
                                            .sendResltToken("/prod-api/system/dict/data/type/li-complaint-question-type", "", "GET", new Callback() {
                                                @Override
                                                public void onFailure(@NonNull okhttp3.Call call, @NonNull IOException e) {
...
////                                                                            "dictSort": 4,
                                                                ...
                                                                try {
                                                                    ...
                                                                    new HttpUtil()
                                                                            .sendResltToken("/prod-api/api/logistics-inquiry/logistics_complaint", jsonObject1.toString(), "POST", new Callback() {
                                                                                @Override
