...
import com.example.myapplication3.ui.DDLB;
import com.example.myapplication3.ui.GRXX;
import com.example.myapplication3.ui.XGMM;
import com.example.myapplication3.ui.YJFK;
...
public class E extends Fragment {
    ...
    private void XS() {
        new HttpUtil()
                .sendResltToken("/prod-api/api/common/user/getInfo", "", "GET", new Callback() {
                    @Override
