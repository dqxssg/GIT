...
public class HttpUtil {
    ...
    public void sendResltToken(String url, String msg, String method, Callback callback) {
    ...
    public void sendReslt(String url, String msg, String method, Callback callback) {
        OkHttpClient client = new OkHttpClient();
        RequestBody body = null;
        if (method.equalsIgnoreCase("POST")) {
            body = RequestBody.create(MediaType.parse("application/json"), msg);
