...
import com.example.myapplication4.ui.A_SS;
import com.example.myapplication4.ui.A_XQ;
...
public class A extends Fragment {
    ...
    private Adapter_F_A_GV adapter_f_a_gv;
                ...
                .sendResultToken("/prod-api/api/service/list", "", "GET", new Callback() {
                    ...
                    public void onResponse(@NonNull Call call, @NonNull Response response) throws IOException {
                        ...
                        try {
                            ...
                            adapter_f_a_gv = new Adapter_F_A_GV(getActivity(), s_f_a_gvArrayList);
                            getActivity().runOnUiThread(() -> {
                                gridview.setAdapter(adapter_f_a_gv);
                    ...
                    public void onResponse(@NonNull Call call, @NonNull Response response) throws IOException {
                        ...
                        try {
                            ...
                            getActivity().runOnUiThread(() -> {
                                for (int i = 0; i < jsonArray.length(); i++) {
                                    try {
                                        table.addTab(table.newTab().setText(jsonArray.getJSONObject(i).getString("name")));
                                    } catch (JSONException e) {
                                        throw new RuntimeException(e);
                                    }
                                }
                ...
                .sendResultToken("/prod-api/press/press/list?type=" + id, "", "GET", new Callback() {
                    ...
                    public void onResponse(@NonNull Call call, @NonNull Response response) throws IOException {
                        ...
                        try {
                            ...
                            adapter_f_a_lv = new Adapter_F_A_LV(getActivity(), s_f_a_lvArrayList);
                            getActivity().runOnUiThread(() -> {
                                ...
                                int h = 0;
                                for (int i = 0; i < s_f_a_lvArrayList.size(); i++) {
    ...
    private void initView() {
        ...
        table = (TabLayout) getView().findViewById(R.id.table);
