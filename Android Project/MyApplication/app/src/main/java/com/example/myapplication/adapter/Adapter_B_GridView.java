...
public class Adapter_B_GridView extends ArrayAdapter<ShuJv_A_GridView> {
    public Adapter_B_GridView(@NonNull Context context, ArrayList<ShuJv_A_GridView> shuJv_a_listViews) {
