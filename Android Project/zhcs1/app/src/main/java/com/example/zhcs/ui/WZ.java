...
public class WZ extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        new HttpUtil()
                .sendResultToken("/prod-api/api/pet-hospital/pet-doctor/list?name=" + name, "", "GET", new Callback() {
                    @Override
                            ...
                            runOnUiThread(() -> {
                                ...
                                tj.setOnClickListener(v -> {
                                    ...
                                    try {
                                        ...
                                        new HttpUtil()
                                                .sendResultToken("/prod-api/api/pet-hospital/inquiry", jsonObject1.toString(), "POST", new Callback() {
                                                    @Override
                                                    public void onFailure(@NonNull Call call, @NonNull IOException e) {
                                                    }
