...
public class Adapter_XQLB_LV extends ArrayAdapter<S_XQLB_LV> {
    public Adapter_XQLB_LV(@NonNull Context context, ArrayList<S_XQLB_LV> resource) {
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        if (convertView == null) {
            convertView = LayoutInflater.from(parent.getContext()).inflate(R.layout.adapter_xqlb_lv, parent, false);
        ...
        S_XQLB_LV s_zffwrx_lv = getItem(position);
