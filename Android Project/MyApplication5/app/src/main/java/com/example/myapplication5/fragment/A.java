...
import com.example.myapplication5.adapter.Adapter_A_GV;
import com.example.myapplication5.adapter.Adapter_A_LV;
import com.example.myapplication5.bean.S_A_GV;
import com.example.myapplication5.bean.S_A_LV;
import com.example.myapplication5.ui.A_SS;
import com.example.myapplication5.ui.A_XQ;
import com.example.myapplication5.ui.FW;
import com.example.myapplication5.ui.MainActivity;
import com.example.myapplication5.ui.QBFW;
...
public class A extends Fragment {
    ...
    private void LV(String id) {
        new HttpUtil()
                .sendResurltToken("/prod-api/press/press/list?type=" + id, "", "GET", new Callback() {
                    @Override
    ...
    private void TL() {
        new HttpUtil()
                .sendResurltToken("/prod-api/press/category/list", "", "GET", new Callback() {
                    @Override
                    public void onFailure(@NonNull Call call, @NonNull IOException e) {
    ...
    private void RMZT() {
        new HttpUtil()
                .sendResurltToken("/prod-api/press/press/list?hot=y", "", "GET", new Callback() {
                    @Override
                    public void onFailure(@NonNull Call call, @NonNull IOException e) {
                                ...
                                gridview.setOnItemClickListener((parent, view, position, id) -> {
                                    switch (position) {
                                        case 2:
                                            ...
                                            break;
                                        case 9:
                                            startActivity(new Intent(getActivity(), QBFW.class));
                                            break;
                                        default:
